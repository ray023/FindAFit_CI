...
class Feedback extends CI_Controller {
    ...
    public function submit_feedback_post() {
        ...
        $data = array(
            ...
            'user_feedback' => $this->input->post('message'),
            'device_info_cordova' => $this->input->post('cordova'),
            'device_info_model' => $this->input->post('model'),
            'device_info_platform' => $this->input->post('platform'),
            'device_info_uuid' => $this->input->post('uuid'),
            'device_info_version' => $this->input->post('version'),
